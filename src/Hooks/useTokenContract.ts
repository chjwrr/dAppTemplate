...
export function useTokenAllowance(tokenAddress:AddressMap,contractAddress:AddressMap){
  ...
  // const tokenContract = useTokenContract(tokenAddresses)

  // function fetchData(){
  //   if (tokenContract){
  //     return tokenContract.allowance(tokenAddresses, contractAddresses);
  //   }
  // }
  // return useQuery(["useTokenAllowance"+tokenAddresses+contractAddresses], fetchData, {
  //   enabled:!!tokenAddress && !!contractAddress && !!tokenContract,
  // })
}
...
export function useWalletInfo(){
  ...
  async function fetchData(){
    ...
    walletBalance["MAIN_COIN"] = balance.formatted
